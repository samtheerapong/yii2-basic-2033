...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 19, 2023 at 07:23 AM
...
CREATE TABLE IF NOT EXISTS `tasks` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tickets_id` int DEFAULT NULL COMMENT 'Ticket No.',
...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  `tickets_type_id` int DEFAULT NULL COMMENT 'ประเภท',
  `tickets_status_id` int DEFAULT NULL COMMENT 'สถานะ',
  `request_sources_id` int DEFAULT NULL COMMENT 'แหล่งที่มา',
  `tickets_urgency_id` int DEFAULT NULL COMMENT 'ความเร่งรีบ',
  `tickets_impact_id` int DEFAULT NULL COMMENT 'ผลกระทบ',
  `tickets_priority_id` int DEFAULT NULL COMMENT 'ความสำคัญ',
...
INSERT INTO `tickets` (`id`, `request_at`, `request_by`, `updated_by`, `created_at`, `updated_at`, `tickets_number`, `tickets_type_id`, `tickets_status_id`, `request_sources_id`, `tickets_urgency_id`, `tickets_impact_id`, `tickets_priority_id`, `location_id`, `image`) VALUES
(2, '2023-04-18', NULL, NULL, NULL, NULL, NULL, 2, 2, 1, 2, 2, 1, 3, ''),
(3, '2023-04-19', NULL, NULL, NULL, NULL, NULL, 1, 3, 3, 2, 3, 2, 2, ''),
(4, '2023-04-20', NULL, NULL, NULL, NULL, NULL, 2, 2, 2, 1, 1, 3, 4, ''),
(5, '2023-04-20', NULL, NULL, NULL, NULL, NULL, 2, 4, 3, 3, 3, 3, 5, ''),
(6, '2023-04-19', NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 3, 2, 2, 2, ''),
(7, '2023-04-19', NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 1, 1, 1, 3, ''),
(8, '2023-04-06', NULL, NULL, NULL, NULL, NULL, 2, 2, 2, 1, 1, 1, 3, ''),
(9, '2023-04-07', NULL, NULL, NULL, NULL, NULL, 2, 2, 2, 1, 1, 1, 4, ''),
(10, '2023-04-19', NULL, NULL, NULL, NULL, NULL, 1, 3, 1, 1, 1, 1, 3, ''),
(11, '2023-04-20', NULL, NULL, NULL, NULL, NULL, 2, 4, 2, 1, 1, 1, 2, ''),
(12, '2023-04-20', NULL, NULL, NULL, NULL, NULL, 1, 4, 1, 1, 3, 1, 1, '');
...
(1, 'admin', 'sam47290800@gmail.com', '$2y$12$j/MmNOUbN3rI/SrHJnlZTOyFm8YuHsB3KbRqdwnFt0PayZcWcPECi', 'MVeu5xESZPupQjSOeeAHp5v452fQQkbp', 1681800947, NULL, NULL, '::1', 1681800900, 1681800900, 0, 1681875469, 10, 9),
...
(5, 'sawika', 'sawika@nfc.com', '$2y$12$8DsilwgBW17g80fWdeKyMuIIDfZ1Ga/Uw.aHXkJLRXrpkOo5V25fO', '7Re2CJLDg4b2cAU2iSJujnQ1r9nRoxvD', 1681875396, NULL, NULL, '::1', 1681875358, 1681876835, 0, NULL, 10, 1),
(6, 'sarawut', 'sarawut@nfc.com', '$2y$12$uRutp0e7S7INLacL/Ntba.xoP1XvC8RYjdpL/va7VVymR3zSCcFxe', 'M3m3bd-S5t-C7pz0NhaiZFJKmxyqc6O8', 1681875478, NULL, NULL, '::1', 1681875443, 1681876817, 0, NULL, 10, 1);
